...
// Informasi pengguna
$username = 'aden'; // Ganti dengan username yang diinginkan
$password = 'Anaksetan123#'; // Ganti dengan password yang diinginkan
$email = 'adenxploit@gmail.com'; // Ganti dengan email yang diinginkan
